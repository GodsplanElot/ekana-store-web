...
export default async function StaffPage() {
  ...
  const { data, error } = supabase ? await supabase.from("staff_users").select("id,email,display_name,role,is_active,created_at").order("created_at", { ascending: true }) : { data: null, error: new Error("Supabase is not configured") }
